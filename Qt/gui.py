...
"color: rgb(6, 11, 8);")
        ...
        self.add_all_checkbox = QtWidgets.QCheckBox(self.main_panel)
        self.add_all_checkbox.setGeometry(QtCore.QRect(755, 700, 120, 50))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.add_all_checkbox.setFont(font)
        self.add_all_checkbox.setChecked(True)
        self.add_all_checkbox.setObjectName("add_all_checkbox")
...
"color: rgb(6, 11, 8);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_all_checkbox.setText(_translate("MainWindow", "Generate All"))
